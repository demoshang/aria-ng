        ...
        function(
            ...
            if (browserSupportAppCache) {
                ...
                appCache.addEventListener(
                    ...
                    function(e) {
                        for (
                            var i = 0;
                            i < onAppCacheUpdatedCallbacks.length;
                            i++
                        ) {
            ...
            var getOptions = function() {
                ...
                if (!options) {
                    ...
                    if (angular.isArray(options.extendRpcServers)) {
                        for (
                            var i = 0;
                            i < options.extendRpcServers.length;
                            i++
                        ) {
                            var rpcSetting = options.extendRpcServers[i];

                            if (!rpcSetting.rpcHost) {
                                initRpcSettingWithDefaultHostAndProtocol(
                                    rpcSetting
                                );
                            }
                        }
                ...
                if (!parsed) {
                    parsed = new URL(decodeURIComponent(RegExp.$1));
                    var tokenReg = /token=([^?&]+)/i;
                    if (tokenReg.test(location.href)) {
                        parsed.secret = btoa(RegExp.$1);
                    } else {
                        parsed.secret = "";
                    }
                }
            ...
            return {
                ...
                getAllOptions: function() {
                    ...
                    if (options.secret) {
                        options.secret = ariaNgCommonService.base64Decode(
                            options.secret
                        );
                    }
                ...
                getAllRpcSettings: function() {
                    ...
                    if (angular.isArray(options.extendRpcServers)) {
                        for (
                            ...
                            var rpcSetting = cloneRpcSetting(
                                options.extendRpcServers[i]
                            );
                            rpcSetting.rpcId =
                                options.extendRpcServers[i].rpcId;
                ...
                getCurrentRpcSecret: function() {
                    ...
                    return value
                        ? ariaNgCommonService.base64Decode(value)
                        : value;
                },
                ...
                removeRpcSetting: function(setting) {
                    ...
                    for (var i = 0; i < options.extendRpcServers.length; i++) {
                        if (
                            options.extendRpcServers[i].rpcId === setting.rpcId
                        ) {
                ...
                setDefaultRpcSetting: function(setting, params) {
                    ...
                    for (var i = 0; i < options.extendRpcServers.length; i++) {
                        if (
                            ...
                            newDefaultSetting = cloneRpcSetting(
                                options.extendRpcServers[i]
                            );
                            options.extendRpcServers.splice(i, 1);
                            break;
                    ...
                    if (newDefaultSetting) {
                        if (params.keepCurrent) {
                            options.extendRpcServers.splice(
                                0,
                                0,
                                currentSetting
                            );
